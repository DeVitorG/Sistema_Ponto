...
public class Ponto {
	...
	//Essa Função puxa a data para o ponto
	...
	public static void main(String[] args) {
		...
		int mat,retorno = 0; //Variáveis de laço para o programa sempre continuar
		
		//Usuários já cadastrados, por que não tem banco de dados
		usuario[0][0] = "Antônia Adriana Vasconcelos Freitas"; 
		...
		System.out.println("---BEM VINDO AO SISTEMA DE PONTO---"); //Tela de boas vindas dos programa
